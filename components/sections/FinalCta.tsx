...
export function FinalCta({
  ...
  return (
    <section data-chat-avoid className="section" aria-labelledby="final-cta-title">
      <div className="shell">
        <div className="on-ink grain relative overflow-hidden rounded-3xl bg-night px-5 py-9 text-white md:px-12 md:py-14 lg:px-16">
          <div
            aria-hidden="true"
          ...
          />
          <div className="relative grid items-center gap-8 md:gap-10 lg:grid-cols-12">
            <div className="lg:col-span-6">
              ...
              <ul data-reveal className="mt-8 hidden space-y-3 text-[0.9375rem] md:block">
                {[
              ...
              <a
                ...
                className="mt-6 inline-flex items-center gap-3 py-2 text-[1.125rem] font-bold hover:text-glint md:mt-8"
              >
                <Icon name="phone" size={20} /> {business.contact.phoneDisplay}
              </a>
            </div>
            <div data-reveal data-reveal-delay="0.08" data-quote-form className="lg:col-span-5 lg:col-start-8">
